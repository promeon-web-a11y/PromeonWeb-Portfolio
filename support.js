// GENERATED from dc-runtime/src/*.ts 窶・do not edit. Rebuild with `cd dc-runtime && bun run build`.
"use strict";
(() => {
  ...
  function createComponentFactory(registry, ensureFetched) {
    ...
    class StreamableComponent extends React.Component {
      constructor(props) {
        ...
        /** Snapshot of the registry's streaming flags taken at render time 窶能n         *  builders read it off the RenderCtx (this) to pick placeholder vs
        ...
        /** Per-instance constructor error 窶・kept here (not on the registry entry)
       ...
       *  over its initial state 窶・used both at mount and on hot-swap. */
      ...
      /** The props the author's logic + template see 窶・internal __-prefixed
       *  wiring stripped. */
      __userProps() {
  ...
  function init() {
    ...
    const api = {
      ...
      /** Name of the component currently mounted as the page root 窶・DC tools
       *  push their template-stream here when targeting "the open page". */
      __dcRootName: () => rootName,
      /** Editor bridge 窶・the encoded, `data-dc-tpl`-annotated template source.
      ...
      /** Editor bridge 窶・the *original* (decoded) template source. */
